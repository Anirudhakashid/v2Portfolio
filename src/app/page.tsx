...
export default function Home() {
  return (
    <div className="flex h-full w-full items-center justify-center px-4">
      <div
        className="flex w-full max-w-xs flex-col gap-12 
        md:max-w-lg 
        md:screen-line-before md:screen-line-after 
        md:border-x md:border-y md:border-dotted 
        md:border-secondary-foreground/40 
        md:px-4 md:py-8 
        lg:px-8 lg:py-12 
        md:bg-secondary 
        md:rounded-lg 
        md:shadow-lg 
        md:shadow-secondary-foreground/10 
        dark:md:bg-secondary-foreground/5 
        dark:md:border-secondary-foreground/20 
        dark:md:shadow-none 
        dark:md:rounded-none"
      >
        <Main />
        <Navbar />
