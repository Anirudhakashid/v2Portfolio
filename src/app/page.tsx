  ...
  return (
    <div className="flex max-w-full flex-col py-40 md:py-52">
      <div className="flex grow items-center justify-center">
        <div className="flex w-full max-w-xs flex-col gap-12 md:max-w-lg md:screen-line-before md:screen-line-after md:border md:border-secondary-foreground/20 md:px-4 md:py-8 lg:px-8 lg:py-12 md:bg-[#111111] md:rounded-lg">
          <Main />
          <Navbar />
